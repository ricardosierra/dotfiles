...
| **5. Modernização bootstrap (parte 2)** | unificar `20_linux_apt.sh + 20_ubuntu_apt.sh` num `20_apt.sh`; remover `vendor/rbenv` + 6 plugins `rbenv-*` em `link/.rbenv/plugins/` (refatorar `source/50_ruby.sh` pra usar rbenv via PATH) | pendente |
