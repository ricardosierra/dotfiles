...
| **4. Fixes pendentes do REVIEW2** | SRC-01 (shadowing `git/ssh/scp`), shebang `/usr/bin/zsh` em 01_path.sh, `$CORE` undefined, `ANDROID_HOME` hardcoded, R2 (eval thefuck) | pendente |
